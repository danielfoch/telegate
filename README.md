...
- Codex, Claude Code, locally configured command adapters, and HTTPS task-submission adapters. An optional [Grok Bot / Clydesdale adapter](docs/integrations/GROKBOT.md) submits saved tasks to a dedicated Grok webhook routine and accepts completion callbacks. Configure the routine and relay before using it; other cloud adapters still require a compatible provider endpoint.
